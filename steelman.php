...
<html lang="en">
  <head>
    ...
    <title>Steel Man - CharactersNJ</title><!-- CHANGE TO CHARACTER -->
...
<?php 
    ...
    if (isset($_POST['submit']))
    {
        ...
        if (!$error)
        {
            ...
            $subject = "STEEL MAN Booking from " . $name; //CHANGE TO CHARACTER
...
<div class="container">
	<div class="row">
		...
		<div class="col-sm-5">
			<ol class="breadcrumb">
				<li><a href="characters.html">&#10094;&#10094; Characters</a></li>
				<li class="active">Steel Man</li>
			</ol>
			<h2 class="text-center">Steel Man</h2>
			<img src="img/steel-man.jpg" alt="Steel Man" class="img-responsive">
		</div>
		
		<div class="col-sm-7 booking-form">
            <p>Book the <strong>Steel Man</strong> today for your next party! Once your booking is submitted, one of our <a href="index.html">CharactersNJ</a> representatives will contact you with more information on payment as well as planning ahead for your event.</p>
