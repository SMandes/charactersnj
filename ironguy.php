...
<html lang="en">
  <head>
    ...
    <title>Iron Guy - CharactersNJ</title><!-- CHANGE TO CHARACTER -->
...
<?php 
    ...
    if (isset($_POST['submit']))
    {
        ...
        if (!$error)
        {
            ...
            $subject = "IRON GUY Booking from " . $name; //CHANGE TO CHARACTER
...
<div class="container">
	<div class="row">
		...
		<div class="col-sm-5">
			<ol class="breadcrumb">
				<li><a href="characters.html">&#10094;&#10094; Characters</a></li>
				<li class="active">Iron Guy</li>
			</ol>
			<h2 class="text-center">Iron Guy</h2>
			<img src="img/iron-guy.jpg" alt="Iron Guy" class="img-responsive">
		</div>
		
		<div class="col-sm-7 booking-form">
            <p>Book the <strong>Iron Guy</strong> today for your next party! Once your booking is submitted, one of our <a href="index.html">CharactersNJ</a> representatives will contact you with more information on payment as well as planning ahead for your event.</p>
